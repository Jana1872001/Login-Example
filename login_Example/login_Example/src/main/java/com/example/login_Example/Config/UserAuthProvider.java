...
public class UserAuthProvider {
    ...
    public Authentication validateTokenStrongly(String token) {
        ...
        Users users = userRepo.findByLogin(decoded.getIssuer())
                .orElseThrow(() -> new AppException("Unknown message ", HttpStatus.NOT_FOUND));

        return new UsernamePasswordAuthenticationToken(userMapper.toUserDto(users), null, Collections.emptyList());
    }
}
